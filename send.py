...
def send_msg(phone_numbers, pairs):
    ...
    mesaje = []
    for pair in pairs:
        mesaje.append(f"Salutare! La Secret Santa ai prins pe {pair[1]['Nume']}, de la camera {pair[1]['Camera']}, cu urmatorul wishlish: \"{pair[1]['Wishlist']}\" si urmatoarele lucruri pe care nu le doreste: \"{pair[1]['Excluse']}\". \nCadourile se vor impartii pe data de 5 Decembrie. Seara frumoasa!🎅🎁🎄")
